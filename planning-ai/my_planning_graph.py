...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        # inconsistent effect: one action adds it the other one removes it and vice versa
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        # check id actions effect is the precondition negation of the other action
        for e in node_a1.action.effect_add:
        ...
        # and the other way around: removed effect should not interfere with pos precond
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        # The PgNode.is_mutex method can be used to test whether two nodes are mutually exclusive
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        :return: bool
        """
        # same node symbols but contradicting values
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        :return: bool
        """
        # check all mutexes between each nodes actions
    ...
    def h_levelsum(self) -> int:
        ...
        :return: int
        """
        # AIMA: level sum heuristic returns the sum of the level costs of the goals
        level_sum = 0

        # find a level of each goal and accumulate in level_sum
